package com.tiburela.qsercom.drive;
...
public class DriveServiceHelper {
    ...
    public Task<GoogleDriveFileHolder> createFolder(String folderName, @Nullable String folderId) {
        ...
        return Tasks.call(mExecutor, () -> {
            ...
            File metadata = new File()
                    .setParents(root)  //creamos la carpeta es dicha ruta..
        ...
        return Tasks.call(mExecutor, new Callable<GoogleDriveFileHolder>() {
            ...
            public GoogleDriveFileHolder call() throws Exception {
                ...
                if (folderId == null) {
                    ...
                    root = Collections.singletonList(folderId);  //lo podemos subir el archivo en cierta localizacion..
                }
